...
export const CAPABILITY_REGISTRY:CapabilityDefinition[]=[
  ...
  {id:'growth.market_intelligence.read',label:'Radar de mercado',provider:'modo',source:'MODO Intelligence Engine + Apify',description:'Lê missões e resultados isolados por workspace sobre concorrentes, ofertas, reputação e sinais de demanda.',effect:'read',maturity:'active',approvalRequired:false,roles:['growth','crm','controller']},
  {id:'growth.market_intelligence.collect',label:'Atualizar Radar de mercado',provider:'modo',source:'MODO Intelligence Engine + Apify',description:'Dispara uma nova coleta externa controlada do Radar de Mercado; exige aprovação explícita, permanece isolada por workspace e não envia comunicação.',effect:'prepare',maturity:'guarded',approvalRequired:true,roles:['growth','crm','controller']},
  ...
  {id:'growth.content.create',label:'Criar conteúdo',provider:'modo',source:'MODO Content Engine + OpenAI',description:'Cria drafts de conteúdo isolados por workspace usando contexto de marca e objetivo comercial; não consome créditos MODO do cliente NexOffice e não publica externamente.',effect:'prepare',maturity:'active',approvalRequired:false,roles:['growth']},

...
export const CAPABILITY_REGISTRY:CapabilityDefinition[]=[
  ...
  {id:'documents.alerts.read',label:'Alertas documentais',provider:'docwallet',source:'DocWallet Intelligence',description:'Traz vencimentos, obrigações, partes, valores e alertas documentais para a operação.',effect:'read',maturity:'planned',approvalRequired:false,roles:['documents','secretary','controller']},
  ...
  {id:'growth.prospecting.b2b',label:'Prospecção B2B',provider:'modo',source:'MODO Intelligence Engine',description:'Encontra e prioriza empresas por setor, região e sinais comerciais autorizados.',effect:'read',maturity:'planned',approvalRequired:false,roles:['growth','crm']},

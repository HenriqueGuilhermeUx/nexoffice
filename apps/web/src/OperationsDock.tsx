...
type Tab='assistant'|'documents'|'collections'|'reconciliation'|'integrations';
...
const tabLabel:Record<Tab,string>={assistant:'Assistente',documents:'Documentos',collections:'Cobrança',reconciliation:'Conciliação',integrations:'Integrações'};

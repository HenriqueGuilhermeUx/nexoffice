...
console.log(JSON.stringify({ok:true,privacy:'aggregate_only',accepted:4,rejectedSensitivePayloads:2,priorities:brief.priorities.length,assistant:true},null,2));
